...
export const addItemToCart = (id, quantity) => async (dispatch, getState) => {
  // Added curly braces and corrected async placement
  try {
    ...
    // Display an error message here, I assume you are using some kind of error notification library like 'alert.error'
    // Be sure to handle the error gracefully in your application.
