...
const Cart = () => {
  ...
  const { cartItems } = useSelector((state) => state.cart); //useSelector is used to access cart items from store
      ...
      {cartItems.length === 0 ? (
        <div className="empty-cart">
          <img
            ...
            alt="Empty Cart"
          />
          <a href="/" className="btn center-text">
            <span class="center-content">Go to Home Page</span>
          </a>
        </div>
      ) : (
        <>
                ...
                <>
                  ...
                  <div className="cart-item" key={item.fooditem}>
                    <div className="row">
                      ...
                      <div className="col-4 col-lg-3 mt-4 lg-0">
                        <div className="stockCounter d-line">
                          <span
